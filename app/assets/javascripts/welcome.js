...
window.onload = function(){
    ...
    function workContent(){
        //oWorksContent2
        var data = [
            { img : '/assets/img/worksimg1.jpg' , text : 'New journey' },
            { img : '/assets/img/worksimg2.jpg' , text : 'New BOSS' },
            { img : '/assets/img/worksimg3.jpg' , text : 'New map' },
            { img : '/assets/img/worksimg4.jpg' , text : 'New scenario' }
        ];
    ...
    function homeContent(){
        ...
        var data = [
            { text : 'This summer has come full force'},
            { text : 'A richer storyline'},
            { text : 'Stronger skills stronger Bosses'},
            { text : 'Richer character teams'}
        ];
        create();
        function create(){
            for(var i=0;i<data.length;i++){
    ...
    function courseContent(){
        //oCourseContent3
        var data = [
            { img : '/assets/img/ps4.png' , text : 'ps4首发' },
            { img : '/assets/img/xbox.png' , text : 'xbox360手柄强力推荐' },
            { img : '/assets/img/microsoft.png' , text : 'Microsoft官方同步预售' },
            { img : '/assets/img/tencent.png' , text : 'Tencent WeGame期待您的加入' },
            { img : '/assets/img/sony.png' , text : 'sony持续为你护航' },
            { img : '/assets/img/ubisoft.png' , text : '育碧游戏为您提供' },
            { img : '/assets/img/blizzard.png' , text : '暴雪游戏倾情加盟' },
            { img : '/assets/img/steam.png' , text : 'Steam官方发售预备中' },
            { img : '/assets/img/capcom.png' , text : 'CAPCOM 您的得力助手' },
            { img : '/assets/img/shanda.png' , text : '盛大游戏同步预售中' },
            { img : '/assets/img/nintendo.png' , text : 'Nintendo you can you up' },
            { img : '/assets/img/ea.png' , text : 'EA 不解释' }
        ];
        create();
        function create(){
            var w = 120;
    ...
    function showMusic(){
        ...
        oMusic.onclick = function(){
            if(onoff){
                this.style.background = 'url(/assets/img/musicon.gif)';
//				oAudio.play();
            }
            else{
                this.style.background = 'url(/assets/img/musicoff.gif)';
                oAudio.pause();
            }
            onoff = !onoff;
        };
